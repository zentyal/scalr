<?php
	...
	class Update20120222
	{
		function Run()
		{
			...
			$db->Execute("ALTER TABLE  `role_images` ADD  `architecture` VARCHAR( 6 ) NULL ,
				ADD  `os_family` VARCHAR( 10 ) NULL ,
				ADD  `os_name` VARCHAR( 15 ) NULL ,
				ADD  `os_version` VARCHAR( 10 ) NULL ,
				ADD  `agent_version` VARCHAR( 10 ) NULL
			");

			
			$db->Execute("ALTER TABLE  `role_images` CHANGE  `os_name`  `os_name` VARCHAR( 50 ) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL");
