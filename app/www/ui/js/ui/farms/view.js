		...
		columns: [
			...
			{ text: "Status", width: 100, dataIndex: 'status', sortable: true, xtype: 'templatecolumn', tpl:
				...
				getOptionVisibility: function (item, record) {
					...
					if(item.itemId == 'option.addToDash' || item.itemId == 'option.dashSep')
						return (moduleParams['dashboard_enabled'] == '1'/*Scalr.flags.newDashboardTest==true*/);
					else
						return true;
				},
				...
				optionsMenu: [{
					...
					iconCls: 'scalr-menu-icon-dashboard',
					request: {
						processBox: {
							type: 'action',
