Scalr.regPage('Scalr.ui.billing.details', function (loadParams, moduleParams) {
	...
	var panel = Ext.create('Ext.form.Panel', {
		...
		items: [{
			...
			fieldLabel: 'Plan',
			value: moduleParams['billing']['productName'] + " ( $"+moduleParams['billing']['productPrice']+" / month) [<a href='#/billing/changePlan'>Change plan / Cancel subscription</a>]"
		}, {
			xtype: 'displayfield',
			hidden: (!!moduleParams['billing']['type']),
			fieldLabel: 'Status',
			...
			items: [{
				xtype: 'component',
				padding: 5,
				html: 'Scalr has just launched its referral programme! Refer your friends and receive a $100 Amazon gift card. <a href="http://scalr.net/pricing/referral/?utm_source=scalr&utm_campaign=billing" target="_blank">Learn more</a>'
			}]
		}, {
			xtype: 'fieldset',
			title: 'Features',
