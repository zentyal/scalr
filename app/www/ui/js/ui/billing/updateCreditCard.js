Scalr.regPage('Scalr.ui.billing.updateCreditCard', function (loadParams, moduleParams) {
	...
	var form = Ext.create('Ext.form.Panel', {
		...
		items: [{
			...
			{ xtype: 'component', height: 23, width: 37, margin: '0 0 0 5', html: '<img src="/ui/images/ui/billing/cc_visa.png" />'},
			{ xtype: 'component', height: 23, width: 37, margin: '0 0 0 5', html: '<img src="/ui/images/ui/billing/cc_mc.png" />'},
			{ xtype: 'component', height: 23, width: 37, margin: '0 0 0 5', html: '<img src="/ui/images/ui/billing/cc_amex.png" />'},
			{ xtype: 'component', height: 23, width: 37, margin: '0 0 0 5', html: '<img src="/ui/images/ui/billing/cc_discover.png" />'}
			]
		}, {
			xtype: 'fieldcontainer',
			fieldLabel: 'CVV code',
