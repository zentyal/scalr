Scalr.regPage('Scalr.ui.tools.aws.rds.instances.servStats', function (loadParams, moduleParams) {
	...
	var store = Ext.create('store.store', {
		...
		proxy: {
			type: 'scalr.paging',
			extraParams: {year: today.getFullYear(), envId: Scalr.user.envId},
	...
	return Ext.create('Ext.grid.Panel', {
		...
		store: store,
		stateId: 'grid-tools-aws-rds-instances-servStats-view',
		stateful: true,
		viewConfig: {
		...
		columns: [
			...
			{ xtype: 'templatecolumn', text: "January", width: 120, dataIndex: 'Jan', sortable: false,
			 tpl: '<tpl if="Jan"><center>{Jan}</center></tpl><tpl if="!Jan"><center><img src="/ui2/images/icons/false.png" /></center></tpl>'},
			{ xtype: 'templatecolumn', text: "February", width: 120, dataIndex: 'Feb', sortable: false,
			 tpl: '<tpl if="Feb"><center>{Feb}</center></tpl><tpl if="!Feb"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "March", width: 120, dataIndex: 'Mar', sortable: false,
			 tpl: '<tpl if="Mar"><center>{Mar}</center></tpl><tpl if="!Mar"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "April", width: 120, dataIndex: 'Apr', sortable: false,
			 tpl: '<tpl if="Apr"><center>{Apr}</center></tpl><tpl if="!Apr"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "May", width: 120, dataIndex: 'May', sortable: false,
			 tpl: '<tpl if="May"><center>{May}</center></tpl><tpl if="!May"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "June", width: 120, dataIndex: 'Jun', sortable: false,
			 tpl: '<tpl if="Jun"><center>{Jun}</center></tpl><tpl if="!Jun"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "July", width: 120, dataIndex: 'Jul', sortable: false,
			 tpl: '<tpl if="Jul"><center>{Jul}</center></tpl><tpl if="!Jul"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "August", width: 120, dataIndex: 'Aug', sortable: false,
			 tpl: '<tpl if="Aug"><center>{Aug}</center></tpl><tpl if="!Aug"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "September", width: 120, dataIndex: 'Sep', sortable: false,
			 tpl: '<tpl if="Sep"><center>{Sep}</center></tpl><tpl if="!Sep"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "October", width: 120, dataIndex: 'Oct', sortable: false,
			 tpl: '<tpl if="Oct"><center>{Oct}</center></tpl><tpl if="!Oct"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "November", width: 120, dataIndex: 'Nov', sortable: false,
			 tpl: '<tpl if="Nov"><center>{Nov}</center></tpl><tpl if="!Nov"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' },
			{ xtype: 'templatecolumn', text: "December", width: 120, dataIndex: 'Dec', sortable: false,
			 tpl: '<tpl if="Dec"><center>{Dec}</center></tpl><tpl if="!Dec"><center><img src="/ui2/images/icons/false.png" /></center></tpl>' }
		],
		dockedItems: [{
			xtype: 'toolbar',
			dock: 'top',
			items: [{
				...
				xtype: 'combo',
				hidden: Scalr.user.type == 'AccountOwner' ? false : true,
