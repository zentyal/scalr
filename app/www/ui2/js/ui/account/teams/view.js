    	...
    	'<tpl for=".">',
	        '<div class = "scalr-ui-account-teams-list" style="',
	        	...
	        	'<div class = "block" style = "width: 40%;">',
	          		'<span class = "title">{name}&nbsp;<tpl if="this.teamManage||ownerTeam"><a href="#/account/teams/{id}/edit"><div class = "x-menu-icon-configure" style = "display: inline-block;"></div></a></tpl></span>',
	          		'<br/><span class="desc">&nbsp;{description}</span>',
	          		'<div>',
	          			'<div class = "x-menu-icon-environment" style = "display: inline-block;"></div>',
