<?
	...
	abstract class Core
	{
		...
		*/
		 ...
		 * @static
		 */
		public static function GetDBInstance($connection_info = NULL, $use_nconnect = false, $driver = 'mysqli', $conn_type = 'master')
		{
		    if (function_exists("NewADOConnection"))
		    {
                ...
                $dsn = ($connection_info && !is_array($connection_info)) ? $connection_info : (defined('CF_DB_DSN') ? CF_DB_DSN : '');
		...
		public static function GetPDOInstance ($config=null, $use_nconnect = false, $conn_type = 'master')
		{
			if (is_array($config))
			{
