 ...
 * @since     28.11.2012
 *
 * @property  OwnerData               $owner              A Bucket owner.
 ...
 * @method    OwnerData               getOwner()      getOwner()                 Gets a Bucket owner.
 * @method    AccessControlPolicyData setOwner()      setOwner(OwnerData $owner) Sets a Bucket owner.
