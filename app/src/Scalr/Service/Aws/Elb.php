 ...
 * @since     21.09.2012
 *
 * @property-read  \Scalr\Service\Aws\Elb\Handler\LoadBalancerHandler $loadBalancer  A LoadBalancer handler that is the layer for the related api calls.
 * @method \Scalr\Service\Aws\Elb\V20120601\ElbApi getApiHandler() getApiHandler()
 */
...
/*
    ...
    ->describePolicyTypes (string PolicyTypeName List) returns PolicyTypeDescription
*/